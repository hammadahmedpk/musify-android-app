    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Song> options =
                new FirebaseRecyclerOptions.Builder<Song>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Listen Later").child(FirebaseAuth.getInstance().getUid()).orderByChild("title"), Song.class)
                        .build();
        adapter = new ListenLaterAdapter(options);
