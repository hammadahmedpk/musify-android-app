                ...
                storageRef.child("profile_pics").child(mAuth.getUid()).putFile(dpp).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if(task.isSuccessful()){
                            db.getReference().child("Users").child(mAuth.getUid()).child("profile_pic").setValue(task.getResult().getStorage().getDownloadUrl().toString());
                        }
                        else
                        {
...
//                storageRef.child("profile_pics").child(mAuth.getUid()).putFile(dpp).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
//                    @Override
//                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
//                        Toast.makeText(CreateProfile.this, "In Success~", Toast.LENGTH_SHORT).show();
//                        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
//                            @Override
//                            public void onSuccess(Uri uri) {
//                                Toast.makeText(CreateProfile.this, "In Success", Toast.LENGTH_LONG).show();
//                                db.getReference().child("Users").child(mAuth.getUid()).child("profile_pic").setValue(uri);
//                            }
//                        }).addOnFailureListener(new OnFailureListener() {
//                            @Override
//                            public void onFailure(@NonNull Exception e) {
//                                Toast.makeText(CreateProfile.this, "Failed to Saved Image to Realtime Database!", Toast.LENGTH_LONG).show();
//                            }
//                        });
//                    }
//                });
